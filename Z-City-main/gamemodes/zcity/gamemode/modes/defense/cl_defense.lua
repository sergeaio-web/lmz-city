...
local teams = {
	[1] = {
		objective = "Защищайся против комбайнов.",
		name = "Повстанец",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | Базовый", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
local function CreateVoteMenu()
    ...
    voteMenu.Paint = function(self, w, h)
        ...
        draw.SimpleText("Выберите режим", "Defense_Title", w / 2, 28, Color(230, 230, 230), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.SimpleText("Проголосуйте за режим раундов", "Defense_Subtitle", w / 2, 55, Color(200, 200, 200), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
    ...
    timerPanel.Paint = function(self, w, h)
        ...
        draw.SimpleText("Время:", "Defense_Stats", w / 2, 12, Color(200, 200, 200), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    voteStatsPanel.Paint = function(self, w, h)
        ...
        draw.SimpleText("Статистика голосов:", "Defense_Stats", 20, 20, Color(200, 200, 200), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        draw.SimpleText("Итоговые голоса: " .. totalVotes, "Defense_Stats", w - 20, 20, Color(200, 200, 200), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
        

        draw.RoundedBox(5, 170, 15, 140, 40, Color(50, 100, 200, 150))
        draw.SimpleText("Стандарт: " .. standardPercent .. "%", "Defense_Stats", 240, 33, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Специальный: " .. extendedPercent .. "%", "Defense_Stats", 440, 33, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Зомби апокалипсис: " .. zombiePercent .. "%", "Defense_Stats", 640, 33, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    local modeDescriptions = {
        [1] = {
            ...
            shortDesc = "Классические 6 волн от комбайнов",
        ...
        [2] = {
            ...
            shortDesc = "12 волн нагибания от альянса",
            longDesc = "постарайся выжить сосунок.",
            color = Color(200, 100, 50),
            features = {
                "• 12 волн нагибания",
                "• Специальный босс каждый раунд",
                "• Сложнее чем стандартный - рекомендуется для профи",
                "• Разные типы врагов и турелей"
            }
        },
        [3] = {
            title = "Зомби апокалипсис",
            shortDesc = "6 волн зомби",
            longDesc = "Уникальный режим. ",
            color = Color(50, 200, 50),
            features = {
                "• 6 волн мертвецов",
                "• Уникальный",
                "• Больше врагов чем в стандартном"
            }
        }
    }
    ...
    local function CreateModeButton(index, yPos)
        ...
        button.Paint = function(self, w, h)
            ...
            if self.SelectedFrac > 0 and not isDisabled then
                draw.SimpleText("ВЫБРАН", "Defense_SmallText", w - 120, 50, Color(255, 255, 255, 255 * self.SelectedFrac), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            end
        end
...
MODE.HUDPaint = function(self)
    ...
    if showSelectedMode and CurTime() - selectedModeDisplayTime < selectedModeDisplayDuration then
        ...
        if currentSubMode == "Стандарт" then
            modeName = "Стандартный режим"
            modeColor = Color(50, 150, 255)
            description = "6 волн"
        elseif currentSubMode == "Специальный" then
            modeName = "Специальный режим"
            modeColor = Color(255, 150, 50)
            description = "12 волн нагибания"
        elseif currentSubMode == "Зомби" then
            modeName = "Зомби апокалипсис"
...
local function DrawBossIncomingBanner()
    ...
    draw.SimpleText("БОСС ИДЕТ", "ZB_HomicideMediumLarge", centerX + 2, textY + 2, shadowColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    

    draw.SimpleText("БОСС ЗДЕСЬ", "ZB_HomicideMediumLarge", centerX, textY, textColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    

    local infoY = y + headerHeight + (scaledHeight - headerHeight) / 2
    draw.SimpleText("Более сильные враги!", "ZB_HomicideMedium", centerX, infoY, textColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
