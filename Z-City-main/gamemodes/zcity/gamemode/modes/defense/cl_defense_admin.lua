...
function CreateAdminWaveMenu(subMode, currentWave, totalWaves, isActive)
    ...
    adminWaveMenu.Paint = function(self, w, h)
        ...
        draw.SimpleText("Волна: " .. currentWave .. " / " .. totalWaves, "Defense_AdminText", w/2, 70, ADMIN_MENU.TEXT_COLOR, TEXT_ALIGN_CENTER)
        draw.SimpleText("Sub-Mod: " .. subMode, "Defense_AdminText", w/2, 95, ADMIN_MENU.TEXT_COLOR, TEXT_ALIGN_CENTER)
