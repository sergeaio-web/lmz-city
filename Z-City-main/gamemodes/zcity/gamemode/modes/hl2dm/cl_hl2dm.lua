...
local teams = {
	[0] = {
		objective = "Убейте всех комбайнов и выживите.",
		name = "Повстанец",
	...
	[1] = {
        objective = "Уничтожить всех повстанцев.",
        name = "Солдат Альянса",
        name_elite = "Элитный солдат Альянса",
        name_shotgunner = "Дробовик солдат Альянса",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | Half-Life 2 Мясорубка", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
