...
local teams = {
	[0] = {
		objective = "Убей всех зеленых выблядков",
		name = "Банда Bloodz",
		color1 = Color(180, 0, 0),
		color2 = Color(180, 0, 0)
	},
	[1] = {
		objective = "убей всех красный уебков",
		name = "Банда Groove",
...
function MODE:HUDPaint()
	...
	if timeBeforeSWAT > 0 and zb.ROUND_START + 10.5 < CurTime() then
		...
		surface.DrawText("Сват скоро прийдет!")
		//draw.SimpleText(" Время чтоб пришел SWAT!", "timer_Font2", sw * 0.432, sh * 0.05, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	...
	draw.SimpleText("ZBattle | Гэнгста", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
